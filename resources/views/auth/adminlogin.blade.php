...
<div class="login-box">
    <div class="logo">
        <a href="javascript:void(0);">NutriApple<b></b></a>
        <small></small>
    </div>
    <div class="card">
        <div class="body">
...
<script src="{{ asset('back-end/plugins/jquery-validation/jquery.validate.js')}}"></script>

<!-- Custom Js -->
<script src="{{ asset('back-end/js/admin.js')}}"></script>
<script src="{{ asset('back-end/js/pages/examples/sign-in.js')}}"></script>
</body>
