            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/image-1.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                        <img src="{{asset('image/slider-photo/'.$s->image)}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption sfl sfb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><h4>{{ $s->subtitle }}</h4></div>
                        ...
                        <div class="tp-caption sfl sfb tp-resizeme"
                             ...
                             data-endelementdelay="0.3"
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><h2>{{ $s->title }} <br></h2></div>
                        ...
                        <div class="tp-caption sfl sfb tp-resizeme"
                             ...
                             data-endelementdelay="0.3"
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><div class="text">{!! $s->text !!} <br></div></div>
                        ...
                        <div class="tp-caption sfr sfb tp-resizeme"
                             ...
                             data-endelementdelay="0.3"
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><a href="/about" class="theme-btn btn-style-one">Know more</a> &ensp; <a href="/contact" class="theme-btn btn-style-two">Contact Us</a></div>
